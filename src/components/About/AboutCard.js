          ...
          <Row style={{ 
            ...
            <Col xs={12} md={4} className="education-item" style={{ 
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <p style={{ color: "#6c757d", marginBottom: "5px" }}>
                  <strong>Aditya Junior College</strong>
                </p>
                <p style={{ color: "#b8b8b8", fontSize: "0.9rem" }}>
                  <strong>Percentage:</strong> 86.3%
                </p>
                <p style={{ color: "#b8b8b8", fontSize: "0.9rem" }}>
            ...
            <Col xs={12} md={4} className="education-item" style={{ 
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <p style={{ color: "#6c757d", marginBottom: "5px" }}>
                  <strong>Sir CV Raman School</strong>
                </p>
                <p style={{ color: "#b8b8b8", fontSize: "0.9rem" }}>
                  <strong>GPA:</strong> 9.8/10.0
                </p>
                <p style={{ color: "#b8b8b8", fontSize: "0.9rem" }}>
